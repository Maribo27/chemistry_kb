/* --- src/solution-common.js --- */
var SolutionUIComponent = {};
...
SolutionUIComponent.DrawWindow = function (sandbox) {
    this.sandbox = sandbox;
    this.paintPanel = new SolutionUIComponent.PaintPanel(this.sandbox.container);
...
SCWeb.core.ComponentManager.appendComponentInitialize(SolutionUIComponent.DrawComponent);
